Public Class frmPractice6
    ...
    Private Sub btnCalculate_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnCalculate.Click
        ...
        ElseIf Not (IsNumeric(txtLabScore.Text) And IsNumeric(txtMidterm.Enabled) And IsNumeric(txtFinal.Text)) Then
            MessageBox.Show("ท่านป้อนคะแนนบางรายการไม่เป็นตัวเเลข", "Invalid Data", MessageBoxButtons.OK)
            Exit Sub
        ...
        Else
            ...
            If intSumScore < 50 Then
                If (40 + Val(txtMidterm.Text) + Val(txtFinal.Text)) >= 50 Then
                    drResult = MessageBox.Show("ระดับคะแนนอยู่ในเกณฑ์ช์่วยได้ หากปรับคะแนนเก็บเพิ่มขึ้น" & ControlChars.NewLine & "ท่านตอ้งการติด I ไวก้่อนหรือไม่", "สอบถาม", MessageBoxButtons.YesNo, MessageBoxIcon.Question)
